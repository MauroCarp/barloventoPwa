...
<div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="box box-success">
          ...
          <div class="box-body">
          <div class="chart">
              <canvas id="barChartRCFiltrado" style="height:230px"></canvas>
          </div>
          </div>
    ...
    <div class="col-md-4">
      ...
      <div class="box box-success">
          ...
          <div class="box-body">
          <div class="chart">
              <canvas id="barChart1RCFiltrado" style="height:230px"></canvas>
          </div>
          </div>
    ...
    <div class="col-md-4">  
        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                <canvas id="pieChart1RCFiltrado" style="height:100px"></canvas>
...
<div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            <div class="chart">
              <canvas id="barChart4RCFiltrado" style="height:230px"></canvas>
            </div>
          </div>
